...
#ifndef HEADERANALISI_H
#define HEADERANALISI_H
...
//definition by Stefano Pierini
//#define g2width 10000 // how large hour g(2) has to be
...
{
  time_t Result(static_cast<long>(((Convertee) - EpochDiff) * SecsInDay));
  return Result;
}

#endif // HEADERANALISI_H
